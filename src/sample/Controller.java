...
public class Controller {
    ...
    //These are the declarations for all of the FXID's.
    @FXML
    private Text appleP;
    @FXML
    ...
    //these create new stock quotes so that the information can be pulled from yahoo finance
    ...
    //This calculates the Simple moving average over a given period
    ...
    private void setIndicators() {
        //These get the EMA's for the 26 day and13 day period as well as the MACD
        ...
        //this uses the MACD to change the color of the text according to whether the MACD is - or +
    ...
    private void onUpdatePressed() {
        //gets the most recent closing price and price change for apple
        appleP.setText(apple.getPrice());
        applePC.setText(apple.getPriceChange());

        //gets the most recent closing price and price change for snpachat
        snapP.setText(snap.getPrice());
        snapPC.setText(snap.getPriceChange());

        //gets the most recent closing price and price change for facebook
        facebookP.setText(facebook.getPrice());
        facebookPC.setText(facebook.getPriceChange());

        //gets the most recent closing price and price change for Micorsoft
        microsoftP.setText(facebook.getPrice());
        microsoftPC.setText(microsoft.getPriceChange());

        //gets the most recent closing price and price change for visa
        visaP.setText(visa.getPrice());
        visaPC.setText(visa.getPriceChange());

        //gets the most recent closing price and price change for pepsi
        pepsiP.setText(pepsi.getPrice());
        pepsiPC.setText(pepsi.getPriceChange());

        //gets the most recent closing price and price change for atnt
        atntP.setText(atnt.getPrice());
        atntPC.setText(atnt.getPriceChange());

        //gets the most recent closing price and price change for verizon
        verizonP.setText(verizon.getPrice());
        verizonPC.setText(verizon.getPriceChange());

        //gets the most recent closing price and price change for snapchat
        snapP.setText(snap.getPrice());
        snapPC.setText(snap.getPriceChange());

        //gets the most recent closing price and price change for netflix
        netflixP.setText(netflix.getPrice());
        netflixPC.setText(netflix.getPriceChange());

        //gets the most recent closing price and price change for ea
